  ...
  try {
    ...
    if (existing) {
      return next(
        Object.assign(
          new Error(
            "An admin with this email already exists in your organization",
          ),
          { statusCode: 400 },
        ),
      );
  ...
  try {
    ...
    if (existingManager) {
      return next(
        Object.assign(
          new Error(
            "Manager with this email already exists in your organization",
          ),
          { statusCode: 400 },
        ),
      );
  ...
  try {
    ...
    if (existingUser) {
      return next(
        Object.assign(
          new Error(
            "Employee with this email already exists in your organization",
          ),
          { statusCode: 400 },
        ),
      );
