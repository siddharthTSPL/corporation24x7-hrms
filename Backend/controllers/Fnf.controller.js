...
const generateFnF = async (req, res) => {
  ...
  const {
    ...
    otherIncomeItems, salaryOnHold, reimbursementOnHold, assetRecovery, remarks,
  } = req.body;
...
const createFnFRecord = async ({
  ...
  const deductions = settlement?.deductions || { pf: 0, professionalTax: 0, tds: 0, other: 0, total: 0 };
...
const updateFnF = async (req, res) => {
  ...
  const { id } = req.params;
  const {
    otherIncomeItems, salaryOnHold, reimbursementOnHold, assetRecovery,
  ...
  deductions.total = deductions.pf + deductions.professionalTax + deductions.tds + deductions.other;
