    ...
    <section className="bg-gradient-to-b from-white to-[#fbf7f9]">
      <div className="mx-auto max-w-[900px] px-4 py-7 sm:px-6 sm:py-10">
        <div className="mb-6 text-center">
          <p className="font-ui text-[11px] font-bold uppercase tracking-[0.14em] text-[#9c1d60]">
            Head-to-head comparison
          </p>

          <h2 className="mt-1 font-display text-xl font-extrabold tracking-[-0.04em] text-[#0f2b2b] sm:text-2xl">
            See exactly what you'd save vs. another tool
          </h2>
        ...
        <div className="space-y-3 rounded-2xl border border-[#9c1d60] bg-white p-4 shadow-[0_12px_28px_rgba(12,110,110,.08)] sm:p-5">
          <div className="rounded-xl border border-[#9c1d60] p-4">
            <label className="font-ui text-sm font-bold text-[#0f2b2b]">
              1. Which tool are you comparing?
            </label>
          ...
          <div className="rounded-xl border border-[#9c1d60] p-4">
            ...
            {competitorId === 'custom' ? (
              <input
                ...
                inputMode="numeric"
                placeholder={`Your TorchX estimate uses ${employees} employees`}
                className="mt-3 w-full rounded-lg border border-[#9c1d60] px-3 py-2.5 font-body text-sm outline-none focus:border-[#0c6e6e]"
              />
            ) : (
            ...
            {competitorId === 'custom' ? (
              <div className="mt-3 flex overflow-hidden rounded-lg border border-[#9c1d60] focus-within:border-[#0c6e6e]">
                ...
                <input
                  ...
                  className="min-w-0 flex-1 px-1 py-2.5 font-body text-sm outline-none"
                />

                <span className="self-center pr-3 font-body text-xs text-[#6a8383]">
                  / month
                </span>
              </div>
            ) : (
          ...
          <div className="flex flex-col gap-2 pt-1 sm:flex-row">
            <button
              ...
              disabled={!hasQuote}
              className="flex flex-1 items-center justify-center gap-2 rounded-full bg-[#9c1d60] px-5 py-3 font-ui text-sm font-extrabold text-white transition hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-40"
            >
              <FiPlay size={14} />
              Run comparison
            </button>
            ...
            <button
              onClick={handleReset}
              className="flex items-center justify-center gap-2 rounded-full border border-[#9c1d60] px-5 py-3 font-ui text-sm font-bold text-black transition hover:bg-[#9c1d60]"
            >
              <FiRefreshCw size={14} />
              Reset
            </button>
          ...
          <>
            ...
            <div className="mt-4 grid items-stretch gap-3 sm:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)]">
              <div className="relative order-1 overflow-hidden rounded-xl bg-gradient-to-br from-[#9c1d60] to-[#2b1020] p-4 text-white shadow-[0_14px_30px_rgba(122,0,75,.28)]">
                ...
                <div className="mt-3 flex flex-wrap gap-1">
                  {plan.features.map((feature) => (
                    <span
                      key={feature}
                      className="rounded-full bg-white/15 px-2 py-1 font-body text-[10px] text-white"
                    >
                      {feature}
                    </span>
                  ))}
              ...
              <div className="order-2 hidden items-center justify-center sm:flex">
                <span className="flex h-9 w-9 items-center justify-center rounded-full border border-[#e2b8cf] bg-white font-ui text-[11px] font-extrabold text-[#7A004B]">
                  VS
                </span>
              </div>

              <div className="order-3 rounded-xl border border-[#e2d8dd] bg-[#faf7f8] p-4">
                <p className="font-ui text-[10px] font-bold uppercase tracking-[0.12em] text-[#8b7580]">
                  What you're paying today
                </p>

                <p className="mt-2 font-display text-2xl font-extrabold text-[#5c4a52]">
  ...
  return (
    <div className="h-screen overflow-y-auto bg-[#fbf7f9] font-body text-[#25101d]">
      ...
      <section className="mx-auto max-w-[860px] px-4 pb-6 pt-8 text-center sm:px-6 sm:pt-12">
        <p className="font-ui text-[11px] font-bold uppercase tracking-[0.16em] text-[#9c1d60]">
          India price calculator · FY 2026
        </p>
      ...
      >
            ...
            <div className="mt-3 grid items-stretch gap-4 sm:grid-cols-2 md:grid-cols-3">
              {PLANS.map((item) => {
                ...
                return (
                  ...
                  >
                    {item.popular && (
                      <span className="absolute -top-3 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-full bg-[#7A004B] px-3 py-1 font-ui text-[10px] font-bold text-white">
                        Most Popular
                      </span>
                    )}

                    <span className="font-ui text-base font-extrabold text-[#25101d]">
                      {item.name}
                    </span>
              ...
              <table className="w-full min-w-[620px] border-collapse text-left">
                <thead>
                  <tr className="border-b border-[#ead9e2] bg-[#fdf4f8]">
                    <th className="w-[34%] px-4 py-3 font-ui text-[10px] font-bold uppercase tracking-[0.08em] text-[#8b7580]">
                      Plan
                    </th>
        ...
        <aside className="min-w-0 h-fit lg:sticky lg:top-6">
          ...
          <div className="min-w-0 overflow-hidden rounded-2xl bg-[#2b1020] p-4 text-white sm:p-6">
            <p className="font-ui text-[11px] font-bold uppercase tracking-[0.14em] text-[#f0a4ca]">
              Your estimate
            </p>

            <h3 className="mt-1 break-words font-display text-lg font-extrabold">
              {plan.name} · {employees} employees
            </h3>
            ...
            {bestSavings && (
              ...
              >
                <FiTrendingDown
                  className="mt-0.5 shrink-0 text-[#f0a4ca]"
                  size={16}
                />
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-full bg-white px-5 py-3 font-ui text-sm font-extrabold text-[#7A004B] transition hover:-translate-y-0.5 hover:bg-[#fff1f7]"
            >
              <FiCalendar size={15} />
              Book a Demo
            </button>
            ...
            <div className="mt-5 border-t border-white/10 pt-4">
              <p className="font-ui text-xs font-bold text-[#f7d9e8]">
      ...
      <section className="mx-auto max-w-[860px] px-4 pb-8 sm:px-6">
        ...
        <div className="mt-5 grid gap-5 sm:grid-cols-2">
          <div className="rounded-xl border border-[#efdee7] bg-white p-4">
            <h3 className="font-ui text-sm font-bold text-[#7A004B]">
              Plan structure
            </h3>
      ...
      <section className="mx-auto max-w-[860px] px-4 pb-16 sm:px-6">
        <h2 className="font-display text-xl font-extrabold">
          Common questions
        </h2>
        ...
        <div className="mt-4 divide-y divide-[#efdee7] rounded-xl border border-[#efdee7] bg-white">
          {FAQS.map((item, i) => (
            ...
            >
              ...
              {openFaq === i && (
                <p className="pb-4 font-body text-sm text-[#76616c]">
                  {item.a}
                </p>
              )}
            </div>
