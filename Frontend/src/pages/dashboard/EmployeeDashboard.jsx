      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-7">
        ...
        <div className="flex justify-between items-center mb-5">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="relative w-9 h-9 rounded-xl border border-[#ede5e0] bg-white flex items-center justify-center cursor-pointer">
              ...
              {meLoading
                ...
                : (
                  <>
                    ...
                    <LeaveRow label="Sick Leave (SL)" availed={lb?.SL?.availed??0} entitled={lb?.SL?.entitled??0} accrued={null} color="#1D9E75" />
