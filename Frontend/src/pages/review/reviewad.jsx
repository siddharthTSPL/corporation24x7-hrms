...
function ManagerCard({ manager, selected, onClick }) {
  ...
  return (
    <button
      ...
      className={`w-full flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl border transition-all duration-200 text-left relative overflow-hidden ${
    ...
    >
      {isSelected && (
        <div 
          ...
          style={{ background: `linear-gradient(90deg, ${BRAND.maroon}, ${BRAND.pink})` }} 
        />
      )}
      ...
      <div className="text-left min-w-0 flex-1">
        <p 
          className="m-0 text-sm sm:text-base font-semibold text-[#2D0A1A] truncate" 
        ...
        {manager.designation && (
          <p className="m-0 mt-0.5 text-[11px] text-[#8B1A4A] capitalize truncate">
...
export default function ReviewManager() {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-[#F2EEF0] p-4 sm:p-6 lg:p-8 flex flex-col items-center font-sans text-[#2D0A1A]">
      <link
      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="mb-8 sm:mb-12 text-center">
          <div 
            className="inline-block px-4 py-1 border border-[#D4A0B8] rounded-full text-[11px] tracking-[0.12em] uppercase text-[#8B1A4A] mb-4 bg-[#FAF0F5]"
          >
            Performance Review
          </div>
          <h1 
            className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#2D0A1A] m-0 mb-3 tracking-tight" 
            style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
          >
            Review a Manager
          </h1>
        ...
        {submitted && (
          <div 
            className="p-4 rounded-xl border mb-7 flex items-center gap-3 text-sm" 
            style={{ 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-6 lg:gap-8 items-start">
          ...
          {/* Left — Manager List */}
          <div className="bg-white rounded-2xl border-2 border-[#5C0F30] shadow-md overflow-hidden flex flex-col max-h-[600px] lg:max-h-[700px]">
            <div className="p-4 sm:p-5 border-b border-[#E8D5DF] flex justify-between items-center shrink-0">
            ...
            <div className="p-3 sm:p-4 flex flex-col gap-2 overflow-y-auto">
              ...
              {!isLoading && !isError && managers.length === 0 && (
                <div className="text-[#9B7A8A] text-sm py-4 px-2">No managers found.</div>
              )}
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border-2 border-[#5C0F30] shadow-md overflow-hidden">
            <div className="p-4 sm:p-5 border-b border-[#E8D5DF] flex justify-between items-center">
              <p className="m-0 text-[11px] tracking-[0.1em] uppercase text-[#9B7A8A] font-medium">Your Review</p>
              {selected && (
                <span 
                ...
                <div className="flex flex-col gap-7">
                  ...
                  <div className="flex items-center gap-3 p-3 sm:p-4 bg-[#FAF0F5] rounded-xl border border-[#D4A0B8]">
                    ...
                    <div className="min-w-0">
                      <p className="m-0 text-sm font-medium text-[#2D0A1A] truncate">{getFullName(selected)}</p>
                      ...
                      <div className="flex gap-1 mt-3">
                        {[1, 2, 3, 4, 5].map((i) => (
                          <div 
                            ...
                            style={{ background: i <= rating ? BRAND.pink : BRAND.cardBorder }} 
                          />
                        ))}
                      </div>
                    )}
                  ...
                  <div>
                    ...
                    <div 
                      ...
                      style={{ color: comment.trim().length < 10 ? BRAND.mutedText : BRAND.pink }}
                    >
