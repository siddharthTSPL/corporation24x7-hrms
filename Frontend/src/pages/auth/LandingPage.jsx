    ...
    <div className="min-h-screen bg-transparent text-[var(--text)]">
      ...
      <nav className="flex justify-between items-center px-6 md:px-12 py-4">
        ...
        <div className="flex items-center gap-2">
          <img src="/src/assets/TorchX.svg" alt="logo" className="w-50 h-15" />
        </div>
      ...
      <section className="flex flex-col-reverse md:flex-row items-center px-6 md:px-12 py-12 gap-10">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <button
              onClick={() =>
                (window.location.href = "https://torchxsuite.com/signup")
              }
        ...
        {statsData.map((item, i) => (
          <div key={i} className="flex justify-center">
            ...
            <div className="relative w-36 h-36 md:w-40 md:h-40">
              ...
              {/* FRONT SHAPE */}
              <div
                className="relative z-10 w-full h-full flex flex-col items-center justify-center text-center text-white
      ...
      <footer className="text-center py-6 text-sm text-gray-500 border-t">
        Powered by{" "}
        <span className="font-semibold text-[var(--primary)]">Tech Torch</span>{" "}
        2026
      </footer>
    </div>
  );
