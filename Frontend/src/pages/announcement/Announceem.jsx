...
const PRIORITY_META = {
  high:   { label: "Urgent",  pill: "bg-[rgba(205,22,110,0.10)] border border-[rgba(205,22,110,0.25)] text-[#730042]" },
  medium: { label: "Info",    pill: "bg-[rgba(115,0,66,0.10)] border border-[rgba(115,0,66,0.15)] text-[#730042]" },
  low:    { label: "General", pill: "bg-[rgba(249,248,242,0.9)] border border-[rgba(115,0,66,0.15)] text-[#730042]" },
};

function PriorityPill({ priority }) {
  const m = PRIORITY_META[priority] || PRIORITY_META.low;
  return (
    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-medium tracking-widest uppercase ${m.pill}`}>
      {m.label}
    </span>
  );
}
          ...
          {isLoading ? (
            ...
            <>
              <div className="flex items-center gap-2.5 flex-wrap mb-4">
                ...
                {ann.category && (
                  <span className="text-[10.5px] tracking-widest uppercase text-[rgba(115,0,66,0.45)]">
                    {ann.category}
                  </span>
                )}
              ...
              <h2 className="text-2xl sm:text-3xl font-semibold text-[#730042] leading-snug tracking-tight m-0" style={{ fontFamily: "'Segoe UI', sans-serif" }}>
                {ann.title}
              </h2>
              ...
              {ann.postedBy && (
                <div className="mt-6 pt-4 border-t border-[rgba(115,0,66,0.10)] flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-[rgba(115,0,66,0.45)] m-0">
            ...
            <p className="text-[rgba(115,0,66,0.45)] text-center py-8">
...
function AnnCard({ ann, index, onClick, isFeatured }) {
  return (
    ...
    >
      ...
      <h3 className={`font-semibold text-[#730042] leading-snug mb-2.5 tracking-tight ${isFeatured ? "text-xl sm:text-2xl" : "text-base sm:text-lg"}`} style={{ fontFamily: "'Segoe UI', sans-serif" }}>
        {ann.title}
      </h3>
      ...
      <div className="flex items-center justify-between pt-3.5 border-t border-[rgba(115,0,66,0.10)]">
        {ann.category ? (
          <span className="text-[10.5px] text-[rgba(115,0,66,0.45)] tracking-widest uppercase">
            {ann.category}
          </span>
        ) : <span />}
  ...
  return (
    <div className="min-h-screen bg-[#F9F8F2] flex items-center justify-center p-6">
      <div className="text-center max-w-sm">
        ...
        <h3 className="text-2xl font-semibold text-[#730042] mb-2" style={{ fontFamily: "'Segoe UI', sans-serif" }}>
          Access Restricted
        </h3>
...
const Announceem = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F9F8F2]" style={{ fontFamily: "'Segoe UI', sans-serif" }}>
      <style>{`
        ...
        {!isLoading && announcements.length > 0 && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            {announcements.map((ann, i) => (
              <div
                key={ann._id}
                className={`ann-fadein ${i === 0 ? "sm:col-span-2" : "col-span-1"}`}
