...
/**
 * ActionMenu now renders its dropdown through a React Portal into document.body,
 ...
 * or `overflow-x-auto` (which was happening inside the assets card/table container
 * on mobile, tablet, and even desktop for rows near the container edge).
 */
